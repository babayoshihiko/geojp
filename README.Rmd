...
```{r echo=F, eval=T}
sfCensus <- geojp::read_census_tract(code_pref = 4, code_muni = 215, data_dir = "~/Download/data.temp")
head(sfCensus)
```
...
```{r  echo=F, eval=T}
sfYouto <- geojp::read_landnuminfo_landuse(code_pref = 26, code_muni = 100, year = 2011, data_dir = "~/Download/data.temp")
```
